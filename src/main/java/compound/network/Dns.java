...
public class Dns implements Socket {
    ...
    private final Map<Integer, Connect> attachments = new HashMap<>();
    ...
    public void sendToResolve(String domainName, Connect handler) {
        try {
    ...
    public void read(SelectionKey key) throws IOException {
        if (resolverChannel.receive(readBuff) != null) {
            ...
            Connect session = attachments.remove(response.getHeader().getID());
